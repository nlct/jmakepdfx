...
public class InputTransferHandler extends TransferHandler
{
   public InputTransferHandler(Jmakepdfx jmakepdfx)
   {
      super();
   ...
   public boolean importData(TransferHandler.TransferSupport supp)
   {
      ...
      try
      {
         ...
         for (File f : list)
         {
            if (jmakepdfx.supportsInput(f))
            {
               jmakepdfx.setInputFile(f);
               return true;
            }
         }
      }
