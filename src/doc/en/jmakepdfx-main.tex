...
\graphicspath{{images-\jmakepdfxlangtag/}{../en-sharedimages/}}
...
\TeXJavaHelpLoadResources{jmakepdfx,jmakepdfx-dict-\jmakepdfxlangtag}
...
The profile may be set to either \inlineglsdef{profile.grayscale}
for \manmsg{grayscale} or \inlineglsdef{profile.cmyk} for CMYK.
...
\switchdef{gray}
Use \manmsg{grayscale} profile.

\switchdef{grey}
Synonym for \switch{gray}.

\switchdef{cmyk}
Use CMYK \manmsg{color} profile.
